    ...
    >
      <div className="flex min-h-[135px] w-full items-stretch">
        ...
        <div className="flex min-w-0 flex-1 flex-col justify-center pr-[12px]">
          <h3 className="text-[20px] font-bold leading-[24px] tracking-[-0.5px] text-[#111]">
            {product.name}
          </h3>

          <p className="mt-[6px] line-clamp-2 max-w-[100%] text-[14px] font-normal leading-[19px] text-[#737887]">
            {product.description}
          </p>

          <div className="mt-[9px]">
            <p className="text-[17px] font-bold leading-none text-[#111]">
      ...
      <div className="mt-[24px] h-px w-full bg-[#d8d5cc]" />
    </div>
  );
}